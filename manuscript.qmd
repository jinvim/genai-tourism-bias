...
Some distinguish bias from harm, where bias is defined as having a particular inclination or deviation of model outputs from empirical data [for example @ghosh2025; @wu2024a].
...
# Baseline-Rescaling-Output Model for testing algorithmic biases in tourism
...
Consider a situation where an algorithm has a four-in-ten chance of suggesting US domestic tourists to visit New York City.
...
If, however, only one in ten US domestic tourists visit New York City, then the algorithm does favor New York City beyond the empirical expectation.
