# Demographic profile of the simulation population {#apx-demo}
...
```{r} 
#| label: read-data-robust
#| include: false
source("r/data-robust.r")
```
...
Following @lee2025c, we measure the diversity of tourist origins for each destination $j$ using the entropy index.
